...
export const Callbacks = () => {
  ...
  const handleArrowKeyPan = (data) =>
    console.log("handleArrowKeyPan called", JSON.stringify(data));
  const handleButtonPan = (data) =>
    console.log("handleButtonPan called", JSON.stringify(data));
  const handleButtonZoom = (data) =>
    console.log("handleButtonZoom called", JSON.stringify(data));
  const handleDragPan = (data) =>
    console.log("handleDragPan called", JSON.stringify(data));
  const handleFocusedIntervalClick = (data) =>
    console.log("handleFocusedIntervalClick called", JSON.stringify(data));
  const handleScrollPan = (data) =>
    console.log("handleScrollPan called", JSON.stringify(data));
  const handleScrollZoom = (data) =>
    console.log("handleScrollZoom called", JSON.stringify(data));
